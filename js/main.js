$(document).ready(function () {
  ...
  $("#vertical1")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random1 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random2 + ")").css("opacity", "1");
      $("#vertical1 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random1 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random2 + ")").css("opacity", "0");
      $("#vertical1 .sideimage").attr("style", "display: none");
    });
  $("#vertical2")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random3 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random4 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random5 + ")").css("opacity", "1");
      $("#vertical2 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random3 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random4 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random5 + ")").css("opacity", "0");
      $("#vertical2 .sideimage").attr("style", "display: none");
    });
  $("#vertical3")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random14 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random7 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random6 + ")").css("opacity", "1");
      $("#vertical3 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random14 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random7 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random6 + ")").css("opacity", "0");
      $("#vertical3 .sideimage").attr("style", "display: none");
    });
  $("#vertical4")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random10 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random2 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random4 + ")").css("opacity", "1");
      $("#vertical4 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random10 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random2 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random4 + ")").css("opacity", "0");
      $("#vertical4 .sideimage").attr("style", "display: none");
    });
  $("#vertical5")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random7 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random12 + ")").css("opacity", "1");
      $("#vertical5 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random7 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random12 + ")").css("opacity", "0");
      $("#vertical5 .sideimage").attr("style", "display: none");
    });
  $("#vertical6")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random11 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random2 + ")").css("opacity", "1");
      $("#vertical6 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random11 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random2 + ")").css("opacity", "0");
      $("#vertical6 .sideimage").attr("style", "display: none");
    });
  $("#vertical7")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random6 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random7 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random12 + ")").css("opacity", "1");
      $("#vertical7 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random6 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random7 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random12 + ")").css("opacity", "0");
      $("#vertical7 .sideimage").attr("style", "display: none");
    });
  $("#vertical8")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random13 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random14 + ")").css("opacity", "1");
      $("#vertical8 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random13 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random14 + ")").css("opacity", "0");
      $("#vertical8 .sideimage").attr("style", "display: none");
    });
  $("#vertical9")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random5 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random3 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random9 + ")").css("opacity", "1");
      $("#vertical9 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random5 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random3 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random9 + ")").css("opacity", "0");
      $("#vertical9 .sideimage").attr("style", "display: none");
    });
  $("#vertical10")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random14 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random8 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random1 + ")").css("opacity", "1");
      $("#vertical10 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random14 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random8 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random1 + ")").css("opacity", "0");
      $("#vertical10 .sideimage").attr("style", "display: none");
    });
  $("#vertical11")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random10 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random4 + ")").css("opacity", "1");
      $("#vertical11 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random10 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random4 + ")").css("opacity", "0");
      $("#vertical11 .sideimage").attr("style", "display: none");
    });
  $("#vertical12")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random9 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random12 + ")").css("opacity", "1");
      $("#vertical12 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random9 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random12 + ")").css("opacity", "0");
      $("#vertical12 .sideimage").attr("style", "display: none");
    });
  $("#vertical13")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random8 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random10 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random5 + ")").css("opacity", "1");
      $("#vertical13 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random8 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random10 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random5 + ")").css("opacity", "0");
      $("#vertical13 .sideimage").attr("style", "display: none");
    });
  $("#vertical14")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random3 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random14 + ")").css("opacity", "1");
      $("#vertical14 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random3 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random14 + ")").css("opacity", "0");
      $("#vertical14 .sideimage").attr("style", "display: none");
    });
  $("#vertical15")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random7 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random1 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random10 + ")").css("opacity", "1");
      $("#vertical15 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random7 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random1 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random10 + ")").css("opacity", "0");
      $("#vertical15 .sideimage").attr("style", "display: none");
    });
  $("#vertical16")
    .mouseenter(function () {
      $("#horizontal div:nth-child(" + random13 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random12 + ")").css("opacity", "1");
      $("#horizontal div:nth-child(" + random11 + ")").css("opacity", "1");
      $("#vertical16 .sideimage").attr("style", "display: block !important");
    })
    .mouseleave(function () {
      $("#horizontal div:nth-child(" + random13 + ")").css("opacity", "0");
      $("#horizontal div:nth-child(" + random12 + ")").css("opacity", "0");
  ...
  $(".year1").on("click", function () {
    if ($(".year2, .year3, .year4").hasClass("active")) {
      $(".year2, .year3, .year4").removeClass("active");
      $(".w2020, .w2021, .w2022").hide();

      $(".w2019").slideToggle();
      $(this).toggleClass("active");
    } else if ($(".all-button1").hasClass("active")) {
      $(".all-button1").removeClass("active");
      $(".w2020, .w2021, .w2022").slideToggle();
      $(this).toggleClass("active");
    } else {
      $(this).toggleClass("active");
      $(".w2020, .w2021, .w2022").slideToggle();
  ...
  $(".year2").on("click", function () {
    if ($(".year1, .year3, .year4").hasClass("active")) {
      $(".year1, .year3, .year4").removeClass("active");
      $(".w2019, .w2021, .w2022").hide();

      $(".w2020").slideToggle();
      $(this).toggleClass("active");
    } else if ($(".all-button1").hasClass("active")) {
      $(".all-button1").removeClass("active");
      $(".w2019, .w2021, .w2022").slideToggle();
      $(this).toggleClass("active");
    } else {
      $(this).toggleClass("active");
      $(".w2019, .w2021, .w2022").slideToggle();
  ...
  $(".year3").on("click", function () {
    if ($(".year1, .year2, .year4").hasClass("active")) {
      ...
      $(".w2019, .w2020, .w2022").hide();

      $(".w2021").slideToggle();
      $(this).toggleClass("active");
    } else if ($(".all-button1").hasClass("active")) {
      $(".all-button1").removeClass("active");
      $(".w2019, .w2020, .w2022").slideToggle();
      $(this).toggleClass("active");
    } else {
      $(this).toggleClass("active");
      $(".w2019, .w2020, .w2022").slideToggle();
  ...
  $(".all-button1").on("click", function () {
    ...
    $(".w2019, .w2020, .w2021, .w2022").show("slow");
    $(this).toggleClass("active");
  });
  ...
  $(".cate1").on("click", function () {
    if ($(".cate2, .cate3, .cate4").hasClass("active")) {
      ...
      $(".graphic").slideToggle();
      $(this).toggleClass("active");
    } else if ($(".all-button2").hasClass("active")) {
